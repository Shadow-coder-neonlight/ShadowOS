...
Call Button  2 4 "shutdown" 15 4 "anti virus" 8 8 "  settings  " 4 12 "text editor" 20 12 "calculator" 10 16 "file explorer" 28 8 "games" # Press
Getinput /m %Press% /h 70
...
echo 2 exit
set /p task2=:
if %task2%==1 goto calc
if %task2%==2 goto desk
echo INVALID COMMAND
...
echo 6 exit 
set /p task1=choose:
if %task1% ==1  goto theme1
if %task1% ==2  goto theme2
if %task1% ==3  goto theme3
if %task1% ==4  goto theme4
if %task1% ==5  goto theme5
if %task1% ==6 goto settings
:theme1
cls
color 0A
